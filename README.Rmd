...
The package regulationsgov is to enable users to access and engage with textual data from the [Regulations.gov API](https://open.gsa.gov/api/regulationsgov/). 
...
To access the [Regulations.gov API](https://open.gsa.gov/api/regulationsgov/), you will need to obtain an API key from [data.gov](https://data.gov/), which you can do [here](https://open.gsa.gov/api/regulationsgov/#getting-started). 
