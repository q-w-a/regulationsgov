test_that("construct_comment_url handles dates correctly", {
  ...
  url <- construct_comment_url(key = "DEMO_KEY", agencyId = c("CMS", "EPA"), postedDate = c("2020-02-02", "2020-02-03"))
...
test_that("construct_comment_url handles sort  correctly", {
  ...
  url <- construct_comment_url(agencyId = "FAA", postedDate = c("2020-02-02", "2020-02-03"), sort = "documentId", key = "DEMO_KEY")
  expect_equal(correct, url)
  ...
  url <- construct_comment_url(agencyId = "CMS", lastModifiedDate = c("2019-02-02 12:00:00", "2019-02-05 12:00:00"), sort = "lastModifiedDate", key = "DEMO_KEY")
  expect_equal(correct, url)
...
test_that("construct_comment_url handles commentId argument correctly", {
  ...
  url <- construct_comment_url(commentId = "CMS-2020-0088-18990",
                               attachments = "true",
                               key = "DEMO_KEY")
  expect_equal(correct, url)

  expect_error(construct_comment_url(commentId = "CMS-2020-0088-18990",
                                     attachments = "true",
                                     sort = "agencyId",
                                     key = "DEMO_KEY"),
  ...
  url <- construct_comment_url(searchTerm = "case numbers",
